...
namespace Sonata.Web.Services
{
	...
	public class ServiceResponse<T>
	{
		...
		/// <summary>
		/// Gets a value indicating whether the current <see cref="ServiceResponse{T}"/> contains <see cref="LogLevel.Information"/> <see cref="Log"/>.
		/// </summary>
		[DataMember(Name = "isInfos")]
		public bool IsInfos
		{
		...
		/// <summary>
		/// Gets a value indicating whether the current <see cref="ServiceResponse{T}"/> contains <see cref="LogLevel.Debug"/> <see cref="Log"/>.
		/// </summary>
		[DataMember(Name = "isDebugs")]
		public bool IsDebugs
		{
		...
		/// <summary>
		/// Gets a value indicating whether the current <see cref="ServiceResponse{T}"/> contains <see cref="LogLevel.Warning"/> <see cref="Log"/>.
		/// </summary>
		[DataMember(Name = "isWarnings")]
		public bool IsWarnings
		{
		...
		/// <summary>
		/// Gets a value indicating whether the current <see cref="ServiceResponse{T}"/> contains <see cref="LogLevel.Error"/> <see cref="Log"/>.
		/// </summary>
		[DataMember(Name = "isErrors")]
		public bool IsErrors
		{
		...
		/// <summary>
		/// Gets a value indicating whether the current <see cref="ServiceResponse{T}"/> contains <see cref="LogLevel.Critical"/> <see cref="Log"/>.
		/// </summary>
		[DataMember(Name = "isExceptions")]
		public bool IsExceptions
		{
		...
		/// <summary>
		/// Adds the specified <paramref name="logs"/> to the current <see cref="ServiceResponse{T}"/>.
		/// </summary>
		/// <param name="logs">A list of <see cref="Log"/> to add to the current <see cref="ServiceResponse{T}"/>.</param>
		/// <remarks>Existing logs are not overridden.</remarks>
		public void SetLogs(Dictionary<LogLevel, List<Log>> logs)
		{
			if (logs == null)
		...
		/// <summary>
		/// Adds the specified <paramref name="log"/> to the current <see cref="ServiceResponse{T}"/>.
		/// </summary>
		/// <param name="log">The <see cref="Log"/> to add to the current <see cref="ServiceResponse{T}"/>.</param>
		public void Add(Log log)
		{
			if (log == null)
				throw new ArgumentNullException(nameof(log));
		...
		/// <summary>
		/// Adds the specified Logs to the current <see cref="ServiceResponse{T}"/>.
		/// </summary>
		/// <param name="logs">The Logs to add to the current <see cref="ServiceResponse{T}"/>.</param>
		public void Add(IEnumerable<Log> logs)
		{
			if (logs == null)
				throw new ArgumentNullException(nameof(logs));
